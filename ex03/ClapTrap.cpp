...
void ClapTrap::keepFighting() const
{
...
void ClapTrap::five_boost(const std::string &fragTrap)
{
    _hit += 5;
    _energy += 5;
    std::cout   << "ClapTrap \033[1;95m" << _name << "\033[0m got \033[1;"
                << "96m5\033[0m hit points and \033[1;96m5\033[0m energy points"
                << " from FragTrap \033[1;34m" << fragTrap << "\033[0m."
                << std::endl;
}
